...
const Cookies = () => {
	return (
		<>
			...
			<Page title="Toegankelijkheid" showBackLink="previous">
				<Content>
					<Styled.p>
					...
					<Styled.p>
						...
						veranderen, verwachten wij deze verklaring pas over enkele maanden
						te kunnen publiceren.
					</Styled.p>
					<Styled.h2>Garanderen toegankelijkheid</Styled.h2>
					<Styled.p>
						Wij garanderen een goede toegankelijkheid door de volgende
						maatregelen binnen onze processen:
					</Styled.p>
					<Styled.ul>
						<li>
