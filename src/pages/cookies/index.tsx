			...
			<Page title="Cookies" showBackLink="previous">
				<Content>
					...
					<Styled.p>
						...
						worden 5 dagen op de webserver bewaard zodat ze beschikbaar zijn
						voor het webstatistiekprogramma Piwik. Daarna blijven de logfiles 90
						dagen bewaard voor uitsluitend beveiligingsredenen.
					</Styled.p>
					<Styled.p>
						...
						logfiles in Piwik het laatste octet (cijfergroep) van elk IP-adres
						weg te gooien. Dit gebeurt in een tijdelijk geheugen, voordat de
					...
					<Styled.p>
						...
						bijvoorbeeld cookies die bezoekersaantallen bijhouden.
						<br />
