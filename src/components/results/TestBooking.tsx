...
const TestBooking = () => {
    return (
        <>
                ...
                <Container sx={{
                    ...
                    <div  sx={{
                        ...
                        <p sx={{
                            ...
                            width: '70%',
                            color: 'header',
                        }}>Heb je klachten? Maak direct een afspraak op de website van de GGD</p>
                    </div>
                </Container>
            </a>
            <p sx={{
                fontSize: ['bodyMobile', 'body']
            }}>Of bel <strong>0800-1202</strong>. Houd je burgerservicenummer (BSN) bij de hand.</p>
            <p sx={{
                fontSize: 'smallText',
                color: '#6E6E6E',
                '::before': {
            ...
            }}>We delen geen gegevens met de GGD</p>
        </>
    );
};
