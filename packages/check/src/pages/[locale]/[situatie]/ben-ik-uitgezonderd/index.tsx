...
export const getStaticProps = async ({
	...
	const pageProjection = `{
		...
		${getLocaleProperty({ name: 'uitgezonderdHelpText', locale, block: true })},
		${getLocaleProperty({ name: 'uitgezonderdYesLabel', locale, block: true })},
		${getLocaleProperty({ name: 'uitgezonderdNoLabel', locale, block: true })},
