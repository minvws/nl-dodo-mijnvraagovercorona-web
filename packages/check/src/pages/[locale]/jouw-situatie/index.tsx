			...
			<Page title="Jouw situatie" sx={{ 'dd a': { marginBottom: '16px' } }}>
				<Content>
					<Box sx={{ mt: '36px' }}>
						...
						>
							<Styled.p>
								Je hebt misschien corona als je 1 of meer van deze klachten
								hebt:
							</Styled.p>
							<Styled.ul>
								<li>
						...
						<ExpansionPanel title="Ik ben in de buurt geweest van iemand met corona">
							<Styled.p>
								Als je op 1 dag minstens 15 minuten dichtbij (1,5 meter of
								minder) iemand in de buurt bent geweest met corona, dan heb je
								een verhoogde kans om zelf ook besmet geraakt te zijn.
							</Styled.p>
							<Link href="/" styledAs="button">
						...
						<ExpansionPanel title="Ik heb een melding gekregen van de CoronaMelder app">
							<Styled.p>
								De Coronamelder app stuurt een melding als je op 1 dag minstens
								15 minuten dichtbij iemand in de buurt bent geweest die later
								corona blijkt te hebben. Deze persoon moet ook de app gebruiken.
							</Styled.p>
							<Link href="/" styledAs="button">
						...
						<ExpansionPanel title="Ik ga op reis, of ik kom terug uit het buitenland">
							<Styled.p>
								Als je terugkomt uit buitenlands gebied met een hoog
								coronarisico, moet je bij thuiskomst 10 dagen in
								thuisquarantaine.
							</Styled.p>

							<Styled.p>
								Moet je nog een noodzakelijke reis maken, of weet je niet zeker
								of je in een risicovol gebied bent geweest? Doe dan de
							</Styled.p>
							<Link href="/" styledAs="button">
						...
						<ExpansionPanel title="Ik heb zelf corona">
							<Styled.p>
								Wat vervelend dat je corona hebt. Heb je daarbij ook last van 1
								of meer coronaklachten? Dat zijn:
							</Styled.p>
							<Styled.ul>
								<li>
									Verkoudheidsklachten (zoals neusverkoudheid, loopneus, niezen,
					...
					<Box sx={{ my: '36px' }}>
						...
						<ExpansionPanel title="Iemand bij mij in huis of gezin heeft coronaklachten">
							<Styled.p>
								Als die persoon alleen milde klachten heeft (verkouden,
								loopneus, hoesten) hoef je niet in thuisquarantaine. Maar als
								deze persoon óók last heeft van zware klachten (koorts en/of
								benauwdheid), dan moet je wél in thuisquarantaine.
							</Styled.p>
							<Link href="/" styledAs="button">
						...
						<ExpansionPanel title="Iemand bij mij in huis of gezin heeft corona">
							<Styled.p>
								Als iemand bij jou in huis (of je gezin) corona heeft, moeten
								jij en eventuele andere huisgenoten direct in thuisquarantaine
								gaan en je zo snel mogelijk laten testen.
							</Styled.p>
							<Link href="/" styledAs="button">
						...
						<ExpansionPanel title="Iemand bij mij in huis is in de buurt geweest van iemand met corona">
							...
							<Styled.p>
								<strong>Let op:</strong> je huisgenoot die wél in de buurt was
								van de persoon met corona, moet in thuisquarantaine gaan en
								zichzelf zo snel mogelijk laten testen.
							</Styled.p>
						</ExpansionPanel>
					</Box>
