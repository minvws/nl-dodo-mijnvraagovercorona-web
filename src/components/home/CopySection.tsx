...
const CopySection = () => {
    return (
        <Container sx={{
            ...
            <CopyParagraph id="snel" imageUrl="/images/Illustratie_De_situatie_op_bestemmingRetina.svg"
                           imageAlignment="left">
                <h4>Hoe werkt het?</h4>
            ...
            <CopyParagraph id="actueel" imageUrl="/images/Illustratie_Mobiel_We_vertellen_je_hoe_het_zitRetina.svg"
                           imageAlignment="right">
                <h4>Het resultaat</h4>
            ...
            <CopyParagraph id="thuis-quarantaine" imageUrl="/images/Illustratie_We_helpen_je_op_wegRetina.svg"
                           imageAlignment="left">
                <h4>Het resultaat</h4>
                <h3>We helpen je op weg</h3>
                <p>
                    Ben je tijdens je reis in een gebied geweest met een oranje reisadvies? Vaak heb je voor je terugreis een negatieve testuitslag en verklaring nodig en moet je bij thuiskomst 10 dagen in thuisquarantaine. We helpen je met informatie en tips om alles goed te regelen.
                </p>
            </CopyParagraph>
